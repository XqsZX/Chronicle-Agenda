...
<head>
    <meta charset="UTF-8">
    <title>Disliked Stories</title>
</head>
<body>
    <h1>Disliked Stories</h1>
    <ul>
        <?php if ($result->num_rows > 0): ?>
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <p>You have not disliked any stories yet.</p>
        <?php endif; ?>
    </ul>
